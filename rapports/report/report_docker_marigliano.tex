...
\newminted{diff}{xleftmargin=20pt, linenos=true, breaklines=true, frame=single, framesep=6pt, tabsize=2, fontfamily=courier, fontsize=\small}
...
\begin{versionhistory}
  ...
  \vhEntry{0.0.3}{11.05.16}{\theauthor}{Rédaction des sections Situation actuelle, Séparation des données Docker dans une partition}
  \vhEntry{0.0.4}{06.06.16}{\theauthor}{Rédaction de la configuration du système d'exploitation hôte}
  \vhEntry{0.0.5}{08.06.16}{\theauthor}{Correction et ajout des chapitres Application Hello World et Conclusion}
\end{versionhistory}
...
\item \nameref{chp-app-hello-world} : application de démonstration ayant pour objectif de mettre en pratique les recommandations de sécurité évoquées dans les chapitres précédents
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.3]{img/docker-volume-1.png}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.35]{img/docker-volume-2.png}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.6]{img/luks/partitions_evolution}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.6]{img/docker_hello_world_app.png}
